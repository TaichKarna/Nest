...
| <a name="input_demo_var"></a> [demo\_var](#input\_demo\_var) | testing terraform docs trigger | `string` | n/a | yes |
...
| <a name="input_test_var"></a> [test\_var](#input\_test\_var) | test change | `any` | n/a | yes |
